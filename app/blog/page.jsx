...
//   openGraph: {
//     title: "Blog — Insights & Innovations",
//     description: "Explore articles on AI, development, SEO and digital trends.",
//     images: [
//       {
...
//   // pick first 2 as featured, next 4 as latest (based on blogData order)
...
//           </p>
//           <button className="px-6 py-2 border border-[#3b82f6] text-white font-mono rounded-md hover:bg-[#3b82f6]/10 hover:shadow-[0_0_10px_#3b82f6] transition-all duration-300">
//             Read Latest
//           </button>
//         </div>
//       </section>
...
//               FEATURED READS
//             </h2>
//             <div className="grid grid-cols-2 max-md:grid-cols gap-8">
//               {featuredReads.map((p) => (
//                 <Link
//                   key={p.slug}
//                   href={`/blog/${p.slug}`}
//                   className="block bg-zinc-900 rounded-2xl overflow-hidden shadow-lg"
//                 >
//                   <img
//                     src={p.image}
//                     alt={p.title}
